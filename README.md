...
[Hello Rails](https://github.com/michaelamponsah/hello-react-frontend)
...
```sh
git clone https://github.com/michaelamponsah/hello-rails-backend.git
```
...
Feel free to check the [issues page](https://github.com/michaelamponsah/hello-rails-backend/issues).
